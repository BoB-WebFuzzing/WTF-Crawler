...
func TestDoFilter(t *testing.T) {
	...
	assert.Equal(t, smart.DoFilter(&targets[3]), false)
	...
	assert.Equal(t, smart.DoFilter(&targets[10]), false)
	assert.Equal(t, smart.DoFilter(&targets[11]), false)
	assert.Equal(t, smart.DoFilter(&targets[12]), false)
	assert.Equal(t, smart.DoFilter(&targets[13]), false)
	assert.Equal(t, smart.DoFilter(&targets[14]), false)
}
